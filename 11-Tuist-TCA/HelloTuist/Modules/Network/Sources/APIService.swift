...
//  HelloTuist
//
//  Created by NO SEONGGYEONG on 4/21/25.
//
...
public actor APIService {
    ...
    public func fetchProducts() async throws -> [Product] {
        ...
        do {
            // AF.request + await DataTask의 ㅍalue 프로퍼티로 간단히 비동기 처리
            ...
            // Alamofire 오류 또는 디코딩 오류 등을 NetworkError 로 변환하거나 그대로 전달
            if let afError = error as? AFError {
                ...
                throw NetworkError.unknown // 혹은 error를 그대로 throw
            }
        }
    }
}
