...
final class MenuListViewModelTests: XCTestCase {
    ...
    // 메뉴 리스트 첫 Publisher는 빈 리스트를 발행한다.
    func testWhenFetchingStartsPublishesEmptyMenu() throws {
        try XCTSkipIf(true, "MenuListViewModelTests: testWhenFetchingStartsPublishersEmptyMenu")
    ...
    func testWhenFecthingSucceedsPublishesSectionsBuiltFromReceivedMenuAndGivenGroupingClosure() {
        ...
        let viewModel = MenuList.ViewModel(menuFetching: MenuFetchingStub(returning: .success(expectedMenu)),
