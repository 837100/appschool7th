        ...
        if let segueIndentifier = segue.identifier {
            if segueIndentifier == "save" {
                ...
                if getLocationSwitch.isOn, let location = currentLocation {
                    newJournalEntry = JournalEntry(rating: rating, title: title, body: body, photo: photo, latitude: location.coordinate.latitude, longitude: location.coordinate.longitude)
                } else {
                    newJournalEntry = JournalEntry(rating: rating, title: title, body: body, photo: photo)
                }
            }
