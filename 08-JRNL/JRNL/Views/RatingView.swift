...
class RatingView: UIStackView {
    ...
    func setupButtons() {
        ...
        for _ in 0..<buttonCount {
            ...
            button.heightAnchor.constraint(equalToConstant: buttonSize.height).isActive = false
    ...
    func ratingButtonTapped(button: UIButton) {
        guard let index = ratingButtons.firstIndex(of: button) else {
            fatalError("The buttton, \(button), is not in the ratingButtons array: \(ratingButtons)")
        }
